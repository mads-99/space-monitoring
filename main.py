...
def calculate_social_distancing(vid_path, net, output_dir, output_vid, ln1):
   ...
   #scale requirement for birds eye view
    ...
    while True:
        ...
        # distance_w and distance_h will give 180 cm distance in both horizontal and vertical directions
        ...
        # bottom center point of bounding box for all boxes and will transform all those
